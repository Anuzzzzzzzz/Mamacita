# Project 1: Temperature Unit Converter (temperature_converter.py)


# Description: Create a script that converts between Celsius, Fahrenheit, and
# Kelvin.
...
# 5. Interactive menu for user choice


# 6. Input validation


# 7. History of conversions
...
# Basic conversion functions for
# C↔F
# Add Kelvin conversions
# Create a menu system
# Add conversion history tracking
# Save history to a text file
# Add temperature range warnings
# (e.g., "Freezing point!")
            

# Temperature Converter - Simple Version
